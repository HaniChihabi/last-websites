...
export default function IndexSectionFeatures12() {
  ...
  <div className="container px-4 mx-auto">
    <div className="mb-20 md:max-w-xl text-center mx-auto">
      ...
      <h2 className="text-7xl lg:text-8xl text-white tracking-tighter-xl">Features</h2>
    </div>
    <div className="flex flex-wrap -m-4">
      <div className="w-full md:w-1/3 p-4">
        <div className="px-10 pt-14 pb-12 h-full bg-gradient-radial-dark border border-gray-900 border-opacity-30 rounded-3xl">
          <a className="inline-block mb-6 px-5 py-3 text-sm text-white hover:text-black font-medium hover:bg-green-500 tracking-tight border-2 border-white hover:border-green-500 focus:ring-4 focus:ring-green-500 focus:ring-opacity-40 rounded-full transition duration-200" href="#">Get in touch</a>
          <h3 className="mb-6 text-4xl text-white tracking-tighter-xl">Proof of Transfer</h3>
          <p className="mb-40 text-white">Nightsable is a strategic branding agency focused on brand creation, rebrands, and brand</p>
