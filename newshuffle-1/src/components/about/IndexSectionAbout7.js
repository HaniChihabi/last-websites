...
export default function IndexSectionAbout7() {
    return (
        <React.Fragment>
            <>
  ...
  <div className="container px-4 mx-auto">
    <div className="md:max-w-xl text-center mx-auto mb-20">
      ...
      <h2 className="text-7xl text-white tracking-tighter-xl">About us</h2>
    </div>
    <div className="max-w-5xl mx-auto">
      <div className="flex flex-wrap lg:items-center -m-8 lg:-m-12">
        <div className="w-full md:w-1/2 p-8 lg:p-12">
          <div className="max-w-max mx-auto">
            <img className="rounded-3xl" src="nightsable-assets/images/abouts/about.png" alt="" />
          </div>
        </div>
        <div className="w-full md:w-1/2 p-8 lg:p-12">
          <span className="inline-block mb-4 text-sm text-green-400 font-medium tracking-tighter">Check our stats</span>
          <h2 className="mb-6 text-6xl md:text-7xl text-white tracking-tighter">Making credit history with nightcard</h2>
          <p className="mb-10 text-white text-opacity-60 md:max-w-xs">Nightsable is a strategic branding agency focused on brand creation, rebrands, and brand</p>
