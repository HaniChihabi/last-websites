...
export default function AboutSectionAbout2() {
    return (
        <React.Fragment>
            <>
  ...
  <div className="container px-4 mx-auto">
    <div className="relative text-center md:max-w-4xl mx-auto">
      <h2 className="mb-8 text-3xl text-white tracking-tight leading-normal">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting,</h2>
      ...
      <img className="absolute top-8 -left-20" src="nightsable-assets/images/abouts/star.svg" alt="" />
      <img className="absolute top-48 -right-20" src="nightsable-assets/images/abouts/star-light.svg" alt="" />
    </div>
  </div>
</section>
